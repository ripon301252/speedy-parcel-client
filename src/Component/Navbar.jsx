   ...
   ${isActive
    ...
    const publicLinks = (
        <>
            ...
            {/* <NavLink to={`/parcel-tracking`} className={activeLinks}>Parcel Tracking </NavLink> */}
    ...
    const riderLinks = (
        ...
        /rider/earnings */}
            ...
            <NavLink to={`/completed-deliveries`} className={activeLinks}>Completed Deliveries</NavLink>
