    ...
    <div className="lg:max-w-7xl lg:mx-auto mx-3 lg:py-10 py-5">
      ...
      <div className="hidden md:block overflow-x-auto mt-10">
        ...
        <div className="flex justify-center gap-3 mt-4">
          ...
          <span className="px-3 py-1 border rounded">Page {page}</span>
        ...
        {parcels.map((parcel, i) => (
          ...
          >
            ...
            <p className="flex items-center py-1 gap-1 text-sm rounded-lg">
              ...
              <span
                className={`capitalize font-medium
                    ${parcel.deliveryStatus === "pending-pickup" && "text-yellow-600 bg-yellow-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${parcel.deliveryStatus === "driver_assigned" && "text-blue-600 bg-blue-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${parcel.deliveryStatus === "rider_accepted" && "text-indigo-600 bg-indigo-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${parcel.deliveryStatus === "rider_rejected" && "text-red-600 bg-red-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${parcel.deliveryStatus === "parcel_picked_up" && "text-orange-600 bg-orange-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${parcel.deliveryStatus === "parcel_delivered" && "text-green-600 bg-green-100 px-2 py-1 rounded-lg text-[11px]"}
                    ${!parcel.deliveryStatus && "text-red-600 bg-red-100 px-2 py-1 rounded-lg text-[11px]"}
                    `}
              >
            ...
            <div className="flex gap-2 mt-3">
              ...
              <Link to={`/send-parcel`} className="btn btn-xs btn-secondary">
                Send
              </Link>
              {/* <button
