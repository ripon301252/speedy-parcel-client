...
const Brand = ({ toggle }) => {
  return (
    <div className="md:px-6 py-6 md:py-10">
      <div className="max-w-6xl mx-auto md:px-6 py-6 md:py-10 bg-gray-900  p-10 rounded-2xl">
        {/* Header */}
      ...
      {/* Card 1 */}
      <div className="bg-white border border-gray-300 rounded-2xl p-5 md:p-8 mt-5 text-gray-800 max-w-6xl mx-auto">
